...
sldns() {
wget https://raw.githubusercontent.com/awanklod/reas/main/slowdns/slowdns.sh && chmod +x slowdns.sh && bash slowdns.sh
}
res1() {
...
echo -e "$COLOR1╰══════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭══════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│  [ 1 ]  \033[1;37mDomain xxx.cloudvpn.site      ${NC}"
echo -e "$COLOR1╰══════════════════════════════════════════╯${NC}"
...
clear
echo -e  "$COLOR1╭══════════════════════════════════════════╮${NC}"
echo -e  "$COLOR1│  \033[1;37mContoh subdomain xxx.cloudvpn.site      $COLOR1│${NC}"
echo -e  "$COLOR1│    \033[1;37mxxx jadi subdomain kamu               $COLOR1│${NC}"
echo -e  "$COLOR1╰══════════════════════════════════════════╯${NC}"
echo " "
...
if [[ $dobot == "1" ]]; then
clear
wget https://raw.githubusercontent.com/awanklod/reas/main/dobot/install.sh &> /dev/null
chmod +x install.sh
bash install.sh
rm -rf install.sh
fi
