...
sleep 2
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/awanklod/reas/main/menu/menu.sh" && chmod +x /usr/bin/menu
wget -q -O /usr/bin/m-trgo "https://raw.githubusercontent.com/awanklod/reas/main/menu/m-trgo.sh" && chmod +x /usr/bin/m-trgo
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/awanklod/reas/main/menu/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/awanklod/reas/main/menu/backup.sh" && chmod +x /usr/bin/backup
#wget -q -O /usr/bin/addnoobz "https://raw.githubusercontent.com/awanklod/reas/main/bot/addnoobz.sh" && chmod +x /usr/bin/addnoobz
#wget -q -O /usr/bin/cek-noobz "https://raw.githubusercontent.com/awanklod/reas/main/bot/cek-noobz.sh" && chmod +x /usr/bin/cek-noobz
...
wget -q -O /usr/bin/m-vmess "https://raw.githubusercontent.com/awanklod/reas/main/menu/m-vmess.sh" && chmod +x /usr/bin/m-vmess
wget -q -O /usr/bin/m-vless "https://raw.githubusercontent.com/awanklod/reas/main/menu/m-vless.sh" && chmod +x /usr/bin/m-vless
wget -q -O /usr/bin/m-trojan "https://raw.githubusercontent.com/awanklod/reas/main/menu/m-trojan.sh" && chmod +x /usr/bin/m-trojan
wget -q -O /usr/bin/m-system "https://raw.githubusercontent.com/awanklod/reas/main/menu/m-system.sh" && chmod +x /usr/bin/m-system
wget -q -O /usr/bin/m-sshovpn "https://raw.githubusercontent.com/awanklod/reas/main/menu/m-sshovpn.sh" && chmod +x /usr/bin/m-sshovpn
wget -q -O /usr/bin/m-ssws "https://raw.githubusercontent.com/awanklod/reas/main/menu/m-ssws.sh" && chmod +x /usr/bin/m-ssws
...
wget -q -O /usr/bin/speedtest "https://raw.githubusercontent.com/awanklod/reas/main/speedtest_cli.py" && chmod +x /usr/bin/speedtest
...
wget -q -O /usr/bin/m-allxray "https://raw.githubusercontent.com/awanklod/reas/main/menu/m-allxray.sh" && chmod +x /usr/bin/m-allxray
wget -q -O /usr/bin/xraylimit "https://raw.githubusercontent.com/awanklod/reas/main/menu/xraylimit.sh" && chmod +x /usr/bin/xraylimit
wget -q -O /usr/bin/trialvmess "https://raw.githubusercontent.com/awanklod/reas/main/menu/trialvmess.sh" && chmod +x /usr/bin/trialvmess
